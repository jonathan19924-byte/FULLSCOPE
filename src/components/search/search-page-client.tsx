    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-5 px-4 pt-6 pb-8">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="h-12 w-full rounded-full border border-border bg-muted/50 ps-11 pe-11 text-[16px] text-foreground outline-none [&::-webkit-search-cancel-button]:appearance-none placeholder:text-muted-foreground focus-visible:border-foreground/40"
        />
        {query && (
          <Button
            type="button"
